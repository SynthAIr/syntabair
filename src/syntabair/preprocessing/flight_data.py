...
def load_flight_data(data_path, filename):
    """
    load flight delay data by:
      1. Reading and filtering the CSV file.
      2. Selecting and cleaning columns.
      3. Converting time columns to datetime.
      4. Calculating time offsets and scheduled UTC times.
      5. Computing delays and filtering rows by delay variation.
