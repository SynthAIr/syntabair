"""VAE model implementation for TabSyn."""
...
class Tokenizer(nn.Module):
    ...
    Args:
        ...
        categories (list): List of number of categories for each categorical feature
...
class MultiheadAttention(nn.Module):
    ...
    def forward(self, x_q, x_kv, key_compression=None, value_compression=None):
        ...
        Args:
            ...
            x_kv (torch.Tensor): Key-value tensor
            key_compression (callable, optional): Key compression function
            value_compression (callable, optional): Value compression function
...
class Transformer(nn.Module):
    ...
    Args:
        ...
        d_ffn_factor (int): FFN expansion factor
        attention_dropout (float): Attention dropout rate
        ffn_dropout (float): FFN dropout rate
        residual_dropout (float): Residual dropout rate
        activation (str): Activation function
        prenormalization (bool): Whether to use prenormalization
        initialization (str): Initialization method
    """
...
class Reconstructor(nn.Module):
    """
    Reconstructor for decoding tokens back to tabular data.
    ...
    def forward(self, h):
        ...
        Args:
            h (torch.Tensor): Hidden representations
            
        Returns:
            tuple: Reconstructed numerical and categorical features
        """
        # Split hidden representations for numerical and categorical features
...
class VAE(nn.Module):
    ...
    def forward(self, x_num, x_cat):
        ...
        Returns:
            tuple: Decoder output, mean, and log variance
        """
        # Tokenize input
...
class Model_VAE(nn.Module):
    """
    Full VAE model with tokenizer, encoder, decoder, and reconstructor.
    ...
    def forward(self, x_num, x_cat):
        ...
        Returns:
            tuple: Reconstructed features, mean, and log variance
        """
...
class Encoder_model(nn.Module):
    """
    Encoder component that can be extracted from a trained VAE.
...
class Decoder_model(nn.Module):
    """
    Decoder component that can be extracted from a trained VAE.
