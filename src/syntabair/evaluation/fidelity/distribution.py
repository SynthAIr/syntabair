...
from .common import Goal, get_frequencies, ColumnPairsMetric, MultiColumnPairsMetric

# TODO: add JS divergence

class ColumnPairsContinuousKLDivergence(ColumnPairsMetric):
...
class ColumnPairsDiscreteKLDivergence(ColumnPairsMetric):
...
class ContinuousKLDivergence(MultiColumnPairsMetric):
    ...
    column_pairs_metric = ColumnPairsContinuousKLDivergence
...
class DiscreteKLDivergence(MultiColumnPairsMetric):
    ...
    column_pairs_metric = ColumnPairsDiscreteKLDivergence